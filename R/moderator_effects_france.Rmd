...
Z <- c("BienEtrPro_score", "BC_Coping_actif", "BC_Planification",
       "BC_Soutien_instru", "BC_Soutien_emotio", "BC_Expr_sentiment",
       "BC_Reinterpr_posi", "BC_Acceptation", "BC_Deni", "BC_Blame",
       "BC_Humour", "BC_Religion", "BC_Distraction", "BC_Utili_substanc",
       "BC_Deseng_comport", "PTGI_SF_score", "CD_RISC_score",
       "MSPSS_signif_other", "MSPSS_family", "MSPSS_friends", "MSPSS_score",
       "COPSOQ_soutien_superieur", "COPSOQ_soutien_collegues",
